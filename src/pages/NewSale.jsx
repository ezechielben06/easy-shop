    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-32">
      ...
      <div className="px-4 py-4 max-w-2xl mx-auto">
          ...
          <div className="card mb-4 border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-900/10">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <label className="input-label text-orange-700 dark:text-orange-300">
                  Date d'échéance *
                </label>
                <input
                  type="date"
        ...
        <div className="mt-4 grid grid-cols-3 gap-3">
          ...
          <div
            className={`bg-white dark:bg-gray-800 rounded-xl p-3 border ${isCredit ? "border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-900/10" : "border-gray-200 dark:border-gray-700"}`}
          >
            <p className="text-xs text-gray-500 dark:text-gray-400">Type</p>
            <p
              className={`text-lg font-bold ${isCredit ? "text-orange-500" : "text-green-500"}`}
            >
              {isCredit ? "📝 Crédit" : "💵 Espèces"}
            </p>
          </div>
        </div>
        // Dans le render, remplacez la section Panier par :
        {/* Panier amélioré */}
        <div className="mt-4">
                  ...
                  >
                    ...
                    {item.image_url ? (
                      <img
                        src={item.image_url}
                        alt={item.name}
                        className="w-12 h-12 object-cover rounded-lg flex-shrink-0 border border-gray-200 dark:border-gray-600"
                        onError={(e) => {
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg">
                        <button
                          ...
                          className="w-7 h-7 flex items-center justify-center hover:bg-white dark:hover:bg-gray-600 rounded-l-lg transition-colors text-gray-600 dark:text-gray-300"
                        >
                        ...
                        <button
                          ...
                          className="w-7 h-7 flex items-center justify-center hover:bg-white dark:hover:bg-gray-600 rounded-r-lg transition-colors text-gray-600 dark:text-gray-300"
                        >
            ...
            {saleItems.length > 0 && (
              <div className="card-footer bg-gray-50 dark:bg-gray-800/50">
                ...
                <div className="flex justify-between text-sm mt-1">
                  ...
                  <span className="font-medium">
                    {Math.round(total * 0.18).toLocaleString()} FCFA
                  </span>
                </div>
                <div className="flex justify-between text-lg font-bold mt-2 pt-2 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <span className="text-blue-600 dark:text-blue-400">
                    {Math.round(total * 1.18).toLocaleString()} FCFA
                  </span>
                </div>
              </div>
            )}
